SELECT EVAL_GRP,
  ...
  FROM (SELECT POP_EVAL_GRP_CN,
          ...
          LEFT OUTER JOIN (SELECT POP_STRATUM_CN,
                            ...
                            FROM (SELECT SUM((TREE.FREMVCFAL *
                                   ...
                                   GROUP BY PEU.CN,
                                            ...
                                            POP_STRATUM.CN,
                                            PLOT.CN,
                                            ROUND(PLOT.REMPER)) PLOT_SUMMARY
                           GROUP BY POP_STRATUM_CN,
                                    ESTN_UNIT_CN,
                                    EVAL_CN,
                                    REMPER_YEAR) PHASE_SUMMARY
         ...
         GROUP BY PHASE_1_SUMMARY.POP_EVAL_GRP_CN,
                  ...
                  PHASE_1_SUMMARY.N,
                  REMPER_YEAR) ESTIMATE_BY_ESTN_UNIT
 WHERE NON_ZERO_PLOTS IS NOT NULL
 GROUP BY POP_EVAL_GRP_CN, EVAL_GRP, EVAL_GRP_DESCR, REMPER_YEAR
