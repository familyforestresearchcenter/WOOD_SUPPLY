  ...
  FROM (SELECT POP_EVAL_GRP_CN,
          ...
          LEFT OUTER JOIN (SELECT POP_STRATUM_CN,
                            ...
                            FROM (SELECT SUM((TREE.FREMVCFAL *
                                         ...
                                         PLOT.CN PLT_CN,
                                         CASE
                                           WHEN URBAN_PROP >= 0.00 AND
                                                URBAN_PROP < 0.25 THEN
                                            0
                                           WHEN URBAN_PROP >= 0.25 AND
                                                URBAN_PROP < 0.50 THEN
                                            25
                                           WHEN URBAN_PROP >= 0.50 AND
                                                URBAN_PROP < 0.75 THEN
                                            50
                                           WHEN URBAN_PROP >= 0.75 AND
                                                URBAN_PROP < 1.00 THEN
                                            75
                                           ELSE
                                            -1
                                         END GROUP_BY_FIELD
                                   ...
                                   GROUP BY PEU.CN,
                                            ...
                                            POP_STRATUM.CN,
                                            PLOT.CN,
                                            URBAN_PROP) PLOT_SUMMARY
                           GROUP BY POP_STRATUM_CN,
                                    ESTN_UNIT_CN,
                                    EVAL_CN,
                                    GROUP_BY_FIELD) PHASE_SUMMARY
         ...
         GROUP BY PHASE_1_SUMMARY.POP_EVAL_GRP_CN,
                  ...
                  PHASE_1_SUMMARY.N,
                  GROUP_BY_FIELD) ESTIMATE_BY_ESTN_UNIT
 WHERE NON_ZERO_PLOTS IS NOT NULL
 GROUP BY POP_EVAL_GRP_CN, EVAL_GRP, EVAL_GRP_DESCR, GROUP_BY_FIELD
