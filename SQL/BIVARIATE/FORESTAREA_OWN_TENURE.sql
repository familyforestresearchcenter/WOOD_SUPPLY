SELECT EVAL_GRP,
       EVAL_GRP_DESCR,
       2 ATTRIBUTE_NBR,
       'AREA OF FOREST LAND, IN ACRES' ATTRIBUTE_DESCR,
          ...
          LEFT OUTER JOIN (SELECT POP_STRATUM_CN,
                            ...
                            FROM (SELECT SUM((COND.CONDPROP_UNADJ *
                                ...
                                LEFT OUTER JOIN (SELECT PLT_CN,
                                                           ...
                                                           QUEST_NAME,
                                                           CASE
                                                              WHEN S.NWOSYR - RESPONSE_VALUE >= 0 AND
                                                                  S.NWOSYR - RESPONSE_VALUE < 10 THEN
                                                              0
                                                             WHEN S.NWOSYR - RESPONSE_VALUE >= 10 AND
                                                                  S.NWOSYR - RESPONSE_VALUE < 25 THEN
                                                              10
                                                             WHEN S.NWOSYR - RESPONSE_VALUE >= 25 AND
                                                                  S.NWOSYR - RESPONSE_VALUE < 50 THEN
                                                              25
                                                             WHEN S.NWOSYR - RESPONSE_VALUE >= 50  THEN
                                                              50
                                                             ELSE
                                                              NULL
                                                           END AS TENURE
                                                     ...
                                                     WHERE PO.OWNER_CN = O.CN
                                                       ...
                                                       AND Q.METADATA_CN = 'QMD38') NWOS
                                      ON (NWOS.PLT_CN = PLOT.CN)
