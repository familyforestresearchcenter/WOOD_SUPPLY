  ...
  FROM (SELECT POP_EVAL_GRP_CN,
          ...
          LEFT OUTER JOIN (SELECT POP_STRATUM_CN,
                            ...
                            FROM (SELECT SUM((COND.CONDPROP_UNADJ *
                                         ...
                                         PLOT.CN PLT_CN,
                                         CASE
                                          WHEN PULP_INDEX >= 0 AND
                                                PULP_INDEX < 50 THEN
                                            0
                                           WHEN PULP_INDEX >= 50 AND
                                                PULP_INDEX < 250 THEN
                                            50
                                           WHEN PULP_INDEX >= 250 AND
                                                PULP_INDEX < 500 THEN
                                            250
                                           WHEN PULP_INDEX >= 500 AND
                                                PULP_INDEX < 1000 THEN
                                            500
                                           WHEN PULP_INDEX >= 1000 THEN
                                            1000
                                           ELSE
                                            -1
                                         END GRP_BY_ATTRIB
