  ...
  FROM (SELECT POP_EVAL_GRP_CN,
          ...
          LEFT OUTER JOIN (SELECT POP_STRATUM_CN,
                            ...
                            FROM (SELECT SUM((COND.CONDPROP_UNADJ *
                                         ...
                                         PLOT.CN PLT_CN,
                                          CASE
                                           WHEN PLOT.REMPER >= 0 AND
                                                PLOT.REMPER < 1 THEN
                                            0
                                           WHEN PLOT.REMPER >= 1 AND
                                                PLOT.REMPER < 2 THEN
                                            1
                                           WHEN PLOT.REMPER >= 2 AND
                                                PLOT.REMPER < 3 THEN
                                            2
                                           WHEN PLOT.REMPER >= 3 AND
                                                PLOT.REMPER < 4 THEN
                                            1
                                           WHEN PLOT.REMPER >= 4 AND
                                                PLOT.REMPER < 5 THEN
                                            4
                                           WHEN PLOT.REMPER >= 5 AND
                                                PLOT.REMPER < 6 THEN
                                            5
                                           WHEN PLOT.REMPER >= 6 AND
                                                PLOT.REMPER < 7 THEN
                                            6
                                           WHEN PLOT.REMPER >= 7 AND
                                                PLOT.REMPER < 8 THEN
                                            7
                                           WHEN PLOT.REMPER >= 8 AND
                                                PLOT.REMPER < 9 THEN
                                            8
                                           WHEN PLOT.REMPER >= 9 AND
                                                PLOT.REMPER < 10 THEN
                                            9
                                           WHEN PLOT.REMPER >= 10 THEN
                                            10
                                           ELSE
                                            -1
                                         END GRP_BY_ATTRIB
